...
@register.inclusion_tag("core/partials/list_boolean.html")
def show_check(value):
    return {"bool_val": value}


@register.inclusion_tag("core/partials/list_lock.html")
def show_lock(value):
    return {"bool_val": value}


@register.inclusion_tag("core/partials/input_datetime_bootstrap.html")
...
@register.inclusion_tag("core/partials/input_date_bootstrap.html")
...
@register.inclusion_tag("core/partials/input_icheck.html")
def input_icheck(field):
    """Return HTML markup for a icheck checkbox."""
    return {"field": field}


@register.inclusion_tag("core/partials/input_upload_video.html")
...
@register.inclusion_tag("core/partials/input_upload_image.html")
...
@register.inclusion_tag("core/partials/input_upload_file.html")
