...
class InfluencerTransferredMoney(models.Model):
    ...
    user = models.ForeignKey( 'core.user', on_delete=models.CASCADE, related_name="user_influncer", null=True, blank=True)
    amount = models.PositiveIntegerField(default=0, blank=True, null=True)
    status = models.CharField(max_length=222, blank=True, null=True, choices=STATUS, default='fail')
